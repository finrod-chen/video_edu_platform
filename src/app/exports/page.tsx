  ...
  return (
    <OrgSettingsShell active="下載" breadcrumbExtra="下載">
      <div className="mb-6 border-b border-tebiki-border pb-3">
        <span className="border-b-2 border-tebiki-blue pb-3 text-sm font-medium text-tebiki-blue">視訊檔案</span>
      </div>
      <p className="mb-1 text-sm text-[#5B6270]">您可以下載已上傳的影片檔案。</p>
      <p className="mb-6 text-sm text-[#5B6270]">不包括在 tebiki 中所做的編輯，例如插入、字幕、圖形、剪切、定格、旋轉和畫外音。</p>
      ...
      <label className="relative mb-6 flex max-w-md items-center">
        ...
        <input
          ...
          className="w-full rounded-lg border border-tebiki-border py-2 pl-9 pr-3 text-sm placeholder:text-[#B0B6C0] focus:outline-none focus:ring-2 focus:ring-tebiki-blue/40"
        />
      </label>
