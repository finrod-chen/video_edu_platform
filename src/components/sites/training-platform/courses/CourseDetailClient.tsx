...
import { ChevronDownIcon } from "@/components/sites/training-platform/shared/icons";
import type {
  ManualStatus,
  Course,
  CourseManual,
...
export function CourseDetailClient({
  ...
  return (
    <div className="space-y-4">
      {canManage && (
        <div className="flex items-center justify-between rounded-xl border border-app-border bg-white p-6">
      ...
      {!canManage && quiz && (
        <div className="flex items-center justify-between rounded-xl border border-app-border bg-white p-4">
