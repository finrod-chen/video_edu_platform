...
export function VideoTimeline({
  ...
  if (duration <= 0) {
    return (
      <div className="rounded-xl border border-app-border bg-white p-6 text-center text-sm text-[#8B93A1]">
        載入中…
      </div>
    );
  }
  ...
  return (
    <div className="select-none rounded-xl border border-app-border bg-white p-4">
      {/* Ruler + playhead */}
      <div
        ref={rulerRef}
        className="relative h-6 cursor-pointer rounded bg-app-bg"
