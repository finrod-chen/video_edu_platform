...
import type { QuizScope, Course, Manual } from "@/types/models";
    ...
    <form onSubmit={handleSubmit} className="max-w-md space-y-4">
      ...
      <div>
        ...
        <select
          ...
          className="w-full rounded-lg border border-app-border px-3 py-2.5 text-sm"
        >
      ...
      <div>
        ...
        <input
          ...
          className="w-full rounded-lg border border-app-border px-3 py-2.5 text-sm placeholder:text-[#B0B6C0] focus:outline-none focus:ring-2 focus:ring-brand/40"
        />
      </div>
