...
import { ChevronDownIcon, PlusIcon } from "@/components/sites/training-platform/shared/icons";
import type { ManualStatus, Quiz, QuizQuestion } from "@/types/models";
    ...
    <div className="space-y-6">
      <div className="rounded-xl border border-app-border bg-white p-6">
        ...
        <input
          ...
          className="w-32 rounded-lg border border-app-border px-3 py-2.5 text-sm"
        />
      </div>
            ...
            <div key={q.id} className="rounded-xl border border-app-border bg-white p-4">
              <div className="mb-3 flex items-start gap-3">
                ...
                <input
                  ...
                  placeholder="題目內容"
                  className="flex-1 rounded-lg border border-app-border px-3 py-2 text-sm placeholder:text-[#B0B6C0] focus:outline-none focus:ring-2 focus:ring-brand/40"
                />
                <button
                  type="button"
                ...
                {q.choices.map((c) => (
                  <div key={c.id} className="flex items-center gap-2">
                    ...
                    <input
                      ...
                      placeholder="選項內容"
                      className="flex-1 rounded-lg border border-app-border px-3 py-1.5 text-sm placeholder:text-[#B0B6C0] focus:outline-none focus:ring-2 focus:ring-brand/40"
                    />
                    <button
                      type="button"
