...
export function FolderManager({
  ...
  return (
    <div className="mb-4 rounded-xl border border-app-border bg-white">
      <div className="flex items-center justify-between px-6 py-4">
        ...
        <button
          ...
          className="flex items-center gap-1.5 rounded-lg border border-app-border px-3 py-1.5 text-xs font-medium text-[#2B2C2F] hover:bg-app-bg"
        >
      ...
      {adding && (
        <div className="flex items-center gap-2 border-t border-app-border px-6 py-3">
          <input
            autoFocus
            value={name}
