...
export function Sidebar({ activeKey, role }: { activeKey: NavItemKey | null; role: string }) {
  ...
  return (
    <aside className="hidden md:flex w-[216px] shrink-0 flex-col border-r border-app-border bg-white h-screen sticky top-0">
            ...
            return (
              <li key={item.key}>
                <Link
                  href={item.href}
                  className={cn(
                    "flex items-center gap-3 rounded-md px-3 py-2 text-sm transition-colors hover:bg-app-bg",
                ...
                {item.children && isActive && (
                  <ul className="ml-8 mt-0.5 space-y-0.5 border-l border-app-border pl-3">
                      ...
                      return (
                        <li key={child.href}>
                          <Link
                            href={child.href}
                            className={cn(
                              "flex items-center gap-1 rounded-md px-2 py-1.5 text-sm hover:bg-app-bg",
