...
export function GoogleSignInButton() {
  return (
    ...
    >
      <button
        type="submit"
        className="flex w-full items-center justify-center gap-3 rounded-lg border border-tebiki-border bg-white py-2.5 text-sm font-bold text-[#2B2C2F] hover:bg-tebiki-bg"
      >
        <GoogleGlyph />
        使用 Google 帳號登入
      </button>
