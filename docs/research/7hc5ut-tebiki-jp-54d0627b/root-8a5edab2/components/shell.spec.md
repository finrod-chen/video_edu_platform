...
## Overview
- Target files:
  - `src/components/sites/7hc5ut-tebiki-jp-54d0627b/shared/Sidebar.tsx`
  - `src/components/sites/7hc5ut-tebiki-jp-54d0627b/shared/Topbar.tsx`
  - `src/components/sites/7hc5ut-tebiki-jp-54d0627b/shared/DashboardShell.tsx`
...
- Top: `TebikiLogo` (~28px tall), left-aligned, padding ~24px.
